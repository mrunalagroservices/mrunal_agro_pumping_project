...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        _loading = false;
        _error = context.tr('product_load_error');
      });
    }
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _loading
            ...
            : _error != null || p == null
            ? _ErrorView(
                message: _error ?? context.tr('product_not_found'),
                onRetry: _load,
              )
            : Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        _CircleIcon(
                          icon: state.isWishlisted(p.id)
                              ? Icons.favorite
                              : Icons.favorite_border,
                          tint: state.isWishlisted(p.id)
                              ? AppColors.accent
                              : null,
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        // ── Delivery & services ──────────────────────────
                        Text(
                          context.tr('product_delivery_services'),
                          style: const TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.w500,
                            color: AppColors.text,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      context.tr('product_orders_above'),
                                      style: const TextStyle(
                                        fontSize: 10,
                                        color: AppColors.subtext,
                                      ),
                        ...
                        _InfoLine(
                          ...
                          text: context.tr('product_sold_by'),
                        ),
                        _InfoLine(
                          icon: Icons.payments_outlined,
                          text: context.tr('product_cod_available'),
                        ),
                        _InfoLine(
                          icon: Icons.support_agent_outlined,
                          text: context.tr('product_support_replacement'),
                        ),
                        ...
                        Text(
                          p.description.isNotEmpty
                              ? p.description
                              : context.tr('product_no_description'),
                          style: const TextStyle(
                            fontSize: 12,
                            color: AppColors.subtext,
                            height: 1.5,
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                context.tr('product_ratings_reviews'),
                                style: const TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w500,
                                  color: AppColors.text,
                            ...
                            TextButton(
                              ...
                              child: Text(
                                context.tr('product_write_review'),
                                style: const TextStyle(
                                  fontWeight: FontWeight.w500,
                                  color: AppColors.text,
                                ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: Text(
                              widget.cartQty > 0
                                  ? context.tr('product_add_more')
                                  : context.tr('product_add_to_bag'),
                              style: const TextStyle(
                                fontWeight: FontWeight.w500,
                              ),
                            ),
